...
export { bn as _internalPipelineToExecutePipelineRequestProto } from "./common-08af0b07.rn.js";
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_isFirestoreValue(n) {
    return "object" == typeof n && null !== n && !!("nullValue" in n && (null === n.nullValue || "NULL_VALUE" === n.nullValue) || "booleanValue" in n && (null === n.booleanValue || "boolean" == typeof n.booleanValue) || "integerValue" in n && (null === n.integerValue || "number" == typeof n.integerValue || "string" == typeof n.integerValue) || "doubleValue" in n && (null === n.doubleValue || "number" == typeof n.doubleValue) || "timestampValue" in n && (null === n.timestampValue || function __PRIVATE_isITimestamp(e) {
        ...
        return "object" == typeof n && null !== n && !(!("fields" in n) || null !== n.fields && !e(n.fields));
 ...
 */ function __PRIVATE_valueToDefaultExpr$1(n) {
    let t;
    return n instanceof Expression ? n : (t = e(n) ? __PRIVATE__map(n) : n instanceof Array ? array(n) : __PRIVATE__constant(n, void 0), 
    t);
}
 ...
 */ class Expression {
     ...
     */    asBoolean() {
        ...
        throw new n("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
    }
    subtract(e) {
    ...
    timestampTruncate(e, n) {
        const r = [ this, __PRIVATE_valueToDefaultExpr$1(t(e) ? e.toLowerCase() : e) ];
...
function _field(e, n) {
    return new Field("string" == typeof e ? r === e ? s()._internalPath : i("field", e) : e._internalPath, n);
}
...
function timestampTruncate(e, n, r) {
    const s = t(n) ? __PRIVATE_valueToDefaultExpr$1(n.toLowerCase()) : n;
...
function __PRIVATE_isSelectable(e) {
    const n = e;
    return n.selectable && t(n.alias) && __PRIVATE_isExpr(n.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const n = e;
    return t(n.alias) && n.aggregate instanceof AggregateFunction;
}
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_toPipelineBooleanExpr(e) {
    ...
    } else if (e instanceof A) switch (e.op) {
...
function __PRIVATE_toPipeline(e, n) {
    let t;
    t = E(e) ? n.pipeline().collectionGroup(e.collectionGroup) : p(e) ? n.pipeline().documents([ f(n, e.path.canonicalString()) ]) : n.pipeline().collection(e.path.canonicalString());
    // filters
 ...
 */ class __PRIVATE_Limit extends Stage {
    ...
    constructor(e, n) {
        o(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(n), this.limit = e;
    }
    /**
     * @internal
     * @private
 ...
 */ function __PRIVATE_readUserDataHelper(e, n) {
    return V(e) ? e._readUserData(n) : Array.isArray(e) ? e.forEach((e => e._readUserData(n))) : e.forEach((e => e._readUserData(n))), 
    e;
}
 ...
 */ class PipelineSource {
    ...
    collection(e) {
        ...
        const n = t(e) || g(e) ? {} : e, r = t(e) || g(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        g(r) && this._validateReference(r);
        // Convert user land convenience types to internal types
                const s = t(r) ? r : r.path, i = new __PRIVATE_CollectionSource(s, n), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "collection");
        // Create stage object
    ...
    documents(e) {
        ...
        r.filter((e => e instanceof I)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const s = r.map((e => t(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(s, n), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "documents");
        // Create stage object
                // Add stage to the pipeline
        return i._readUserData(o), this._createPipeline([ i ]);
    }
    ...
    _validateReference(e) {
        ...
        if (!t.isEqual(this.databaseId)) throw new n(m.INVALID_ARGUMENT, `Invalid ${e instanceof w ? "CollectionReference" : "DocumentReference"}. The project ID ("${t.projectId}") or the database ("${t.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ class PipelineResult {
    ...
    get(e) {
        ...
        const n = this._fields.field(i("DocumentSnapshot.get", e));
 ...
 */ function pipelineResultEqual(e, n) {
    return e === n || $(e._ref, n._ref, v) && $(e._fields, n._fields, ((e, n) => e.isEqual(n)));
}
 ...
 */ function __PRIVATE_selectablesToMap(e) {
    ...
    for (const r of e) {
        ...
        s = r.expr) : x(21273, {
            selectable: r
        }), void 0 !== t.get(e)) throw new n("invalid-argument", `Duplicate alias or field '${e}'`);
        t.set(e, s);
    }
    return t;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(n) {
        ...
        t = e(n) ? map(n) : n instanceof Array ? array(n) : __PRIVATE__constant(n, void 0);
        return t;
    }
    /**
 * @license
...
class Pipeline$1 {
    ...
    removeFields(e, ...n) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isField(e) || t(e) ? {} : e, s = (__PRIVATE_isField(e) || t(e) ? [ e, ...n ] : e.fields).map((e => t(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(s, r);
        // Add stage to the pipeline
        // User data must be read in the context of the API method to
        // provide contextual errors
    ...
    select(e, ...n) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isSelectable(e) || t(e) ? {} : e, s = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || t(e) ? [ e, ...n ] : e.selections), i = new __PRIVATE_Select(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "select");
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
    where(e) {
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const n = D(e) ? {} : e, t = D(e) ? e : e.limit, r = new __PRIVATE_Limit(t, n), s = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "limit");
        // Add stage to the pipeline
        return r._readUserData(s), this._addStage(r);
    }
    distinct(e, ...n) {
        // Process argument union(s) from method overloads
        const r = t(e) || __PRIVATE_isSelectable(e) ? {} : e, s = __PRIVATE_selectablesToMap(t(e) || __PRIVATE_isSelectable(e) ? [ e, ...n ] : e.groups), i = new __PRIVATE_Distinct(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "distinct");
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
    aggregate(e, ...t) {
        ...
        const r = __PRIVATE_isAliasedAggregate(e) ? {} : e, s = __PRIVATE_isAliasedAggregate(e) ? [ e, ...t ] : e.accumulators, i = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], o = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, t) => {
                if (void 0 !== e.get(t.alias)) throw new n("invalid-argument", `Duplicate alias or field '${t.alias}'`);
 ...
 */ (s), a = __PRIVATE_selectablesToMap(i), u = new __PRIVATE_Aggregate(a, o, r), _ = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "aggregate");
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const n = t(e) || __PRIVATE_isExpr(e) ? {} : e, r = __PRIVATE_fieldOrExpression(t(e) || __PRIVATE_isExpr(e) ? e : e.map), s = new __PRIVATE_Replace(r, n), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "replaceWith");
        // Add stage to the pipeline
        return s._readUserData(i), this._addStage(s);
    }
    sample(e) {
        ...
        const n = D(e) ? {} : e;
        let t, r;
        D(e) ? (t = e, r = "documents") : D(e.documents) ? (t = e.documents, r = "documents") : (t = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: t, ...n} = e) : (n = {}, t = e);
    ...
    unnest(e, n) {
        ...
        t(i) && (r.indexField = _field(i, "unnest"));
        // Create stage object
     ...
     */    rawStage(n, t, r) {
        // Convert user land convenience types to internal types
        const s = t.map((n => n instanceof Expression || n instanceof AggregateFunction ? n : e(n) ? function __PRIVATE__mapValue(e) {
            const n = new Map;
 ...
 */ function execute(e) {
    const n = e instanceof Pipeline$1 ? {
        pipeline: e
    } : e, {pipeline: t, rawOptions: r, ...s} = n, i = F(t._db, y), o = O(i), a = new b(i._databaseId, 
    ...
    return C(o, _).then((e => {
        ...
        const n = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(t._userDataWriter, e.fields, e.key?.path ? new I(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
...
y.prototype.pipeline = function() {
    const e = M(this);
    return new PipelineSource(this._databaseId, e, (n => new Pipeline(this, e, new q(this), n)));
};
