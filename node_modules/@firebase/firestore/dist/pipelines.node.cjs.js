...
function isIMapValue(obj) {
    ...
    if ('fields' in obj && (obj.fields === null || common692d301d_node.isPlainObject(obj.fields))) {
        return true;
    }
    return false;
}
...
function valueToDefaultExpr$1(value) {
    ...
    else if (common692d301d_node.isPlainObject(value)) {
        result = _map(value);
    }
...
function vectorToExpr$1(value) {
    ...
    else if (value instanceof common692d301d_node.VectorValue) {
        return constant(value);
    }
    else if (Array.isArray(value)) {
        return constant(common692d301d_node.vector(value));
    }
    else {
...
function fieldOrExpression$1(value) {
    if (common692d301d_node.isString(value)) {
...
class Expression {
    ...
    asBoolean() {
        if (this instanceof BooleanExpression) {
            ...
            throw new common692d301d_node.FirestoreError('invalid-argument', `Conversion of type ${typeof this} to BooleanExpression not supported.`);
        }
    }
    subtract(subtrahend) {
    ...
    timestampTruncate(granularity, timezone) {
        const internalGranularity = common692d301d_node.isString(granularity)
...
function _field(nameOrPath, methodName) {
    if (typeof nameOrPath === 'string') {
        if (common692d301d_node.DOCUMENT_KEY_NAME === nameOrPath) {
            return new Field(common692d301d_node.documentId()._internalPath, methodName);
        }
        return new Field(common692d301d_node.fieldPathFromArgument('field', nameOrPath), methodName);
    }
    else {
...
class Constant extends Expression {
     ...
     */
    _toProto(_) {
        common692d301d_node.hardAssert(this._protoValue !== undefined, 0x00ed);
    ...
    _readUserData(context) {
        ...
        if (isFirestoreValue(this._protoValue)) {
            ...
            this._protoValue = common692d301d_node.parseData(this.value, context);
        }
    }
}
...
class MapValue extends Expression {
    ...
    _toProto(serializer) {
        return common692d301d_node.toMapValue(serializer, this.plainObject);
    }
}
/**
 * @beta
...
class Ordering {
    ...
    _toProto(serializer) {
        return {
            mapValue: {
                fields: {
                    direction: common692d301d_node.toStringValue(this.direction),
...
function isSelectable(val) {
    const candidate = val;
    return (candidate.selectable && common692d301d_node.isString(candidate.alias) && isExpr(candidate.expr));
}
...
function isAliasedAggregate(val) {
    const candidate = val;
    return (common692d301d_node.isString(candidate.alias) &&
...
function toPipelineBooleanExpr(f) {
    if (f instanceof common692d301d_node.FieldFilter) {
        ...
        switch (f.op) {
            ...
            default:
                common692d301d_node.fail(0x9047);
        }
    }
    else if (f instanceof common692d301d_node.CompositeFilter) {
        switch (f.op) {
            ...
            default:
                common692d301d_node.fail(0x89ea);
        }
    }
...
function toPipeline(query, db) {
    let pipeline;
    if (common692d301d_node.isCollectionGroupQuery(query)) {
        pipeline = db.pipeline().collectionGroup(query.collectionGroup);
    }
    else if (common692d301d_node.isDocumentQuery$1(query)) {
        pipeline = db.pipeline().documents([common692d301d_node.doc(db, query.path.canonicalString())]);
    }
    else {
    ...
    // orders
    const orders = common692d301d_node.queryNormalizedOrderBy(query);
...
class AddFields extends Stage {
    ...
    get _optionsUtil() {
        return new common692d301d_node.OptionsUtil({});
    }
    ...
    _toProto(serializer) {
        return {
            ...
            args: [common692d301d_node.toMapValue(serializer, this.fields)]
        };
    }
    _readUserData(context) {
...
class Aggregate extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [
                common692d301d_node.toMapValue(serializer, this.accumulators),
                common692d301d_node.toMapValue(serializer, this.groups)
            ]
        };
    }
    _readUserData(context) {
...
class Distinct extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common692d301d_node.toMapValue(serializer, this.groups)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
    ...
    _toProto(serializer) {
        return {
            ...
            args: [
                ...
                common692d301d_node.toStringValue(this.distanceMeasure)
            ]
        };
    }
    _readUserData(context) {
...
class Limit extends Stage {
    ...
    constructor(limit, options) {
        common692d301d_node.hardAssert(!isNaN(limit) && limit !== Infinity && limit !== -Infinity, 0x882c);
        super(options);
        this.limit = limit;
    }
    /**
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common692d301d_node.toNumber(serializer, this.limit)]
        };
    }
}
/**
...
class Offset extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common692d301d_node.toNumber(serializer, this.offset)]
        };
    }
}
/**
...
class Select extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common692d301d_node.toMapValue(serializer, this.selections)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Sample extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common692d301d_node.toNumber(serializer, this.rate), common692d301d_node.toStringValue(this.mode)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Union extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common692d301d_node.toPipelineValue(this.other._toProto(serializer))]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Replace extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [this.map._toProto(serializer), common692d301d_node.toStringValue(Replace.MODE)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
function readUserDataHelper(expressionMap, context) {
    if (common692d301d_node.isUserData(expressionMap)) {
...
class PipelineSource {
    ...
    collection(collectionOrOptions) {
        ...
        const options = common692d301d_node.isString(collectionOrOptions) ||
            common692d301d_node.isCollectionReference(collectionOrOptions)
            ? {}
            : collectionOrOptions;
        const collectionRefOrString = common692d301d_node.isString(collectionOrOptions) ||
            common692d301d_node.isCollectionReference(collectionOrOptions)
            ? collectionOrOptions
            : collectionOrOptions.collection;
        // Validate that a user provided reference is for the same Firestore DB
        if (common692d301d_node.isCollectionReference(collectionRefOrString)) {
            this._validateReference(collectionRefOrString);
        }
        // Convert user land convenience types to internal types
        const normalizedCollection = common692d301d_node.isString(collectionRefOrString)
    ...
    collectionGroup(collectionIdOrOptions) {
        ...
        let collectionId;
        let options;
        if (common692d301d_node.isString(collectionIdOrOptions)) {
    ...
    documents(docsOrOptions) {
        ...
        docs
            .filter(v => v instanceof common692d301d_node.DocumentReference)
            .forEach(dr => this._validateReference(dr));
        // Convert user land convenience types to internal types
        const normalizedDocs = docs.map(doc => common692d301d_node.isString(doc) ? doc : doc.path);
        // Create stage object
    ...
    _validateReference(reference) {
        ...
        if (!refDbId.isEqual(this.databaseId)) {
            throw new common692d301d_node.FirestoreError(common692d301d_node.Code.INVALID_ARGUMENT, `Invalid ${reference instanceof common692d301d_node.CollectionReference
                ? 'CollectionReference'
                : 'DocumentReference'}. ` +
...
class PipelineResult {
    ...
    get(fieldPath) {
        ...
        const value = this._fields.field(common692d301d_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
        if (value !== null) {
...
function pipelineResultEqual(left, right) {
    ...
    return (common692d301d_node.isOptionalEqual(left._ref, right._ref, common692d301d_node.refEqual) &&
        common692d301d_node.isOptionalEqual(left._fields, right._fields, (l, r) => l.isEqual(r)));
}
...
function selectablesToMap(selectables) {
    ...
    for (const selectable of selectables) {
        ...
        if (typeof selectable === 'string') {
            ...
            common692d301d_node.fail(0x5319, { selectable });
        }
        if (result.get(alias) !== undefined) {
            throw new common692d301d_node.FirestoreError('invalid-argument', `Duplicate alias or field '${alias}'`);
        }
...
function aliasedAggregateToMap(aliasedAggregatees) {
    return aliasedAggregatees.reduce((map, selectable) => {
        if (map.get(selectable.alias) !== undefined) {
            throw new common692d301d_node.FirestoreError('invalid-argument', `Duplicate alias or field '${selectable.alias}'`);
        }
...
function vectorToExpr(value) {
    if (value instanceof Expression) {
        ...
        const result = constant(common692d301d_node.vector(value));
        return result;
    }
    else {
        throw new Error('Unsupported value: ' + typeof value);
...
class Pipeline$1 {
    ...
    removeFields(fieldValueOrOptions, ...additionalFields) {
        // Process argument union(s) from method overloads
        const options = isField(fieldValueOrOptions) || common692d301d_node.isString(fieldValueOrOptions)
            ? {}
            : fieldValueOrOptions;
        const fields = isField(fieldValueOrOptions) || common692d301d_node.isString(fieldValueOrOptions)
            ? [fieldValueOrOptions, ...additionalFields]
            : fieldValueOrOptions.fields;
        // Convert user land convenience types to internal types
        const convertedFields = fields.map(f => common692d301d_node.isString(f) ? field(f) : f);
        // Create stage object
    ...
    select(selectionOrOptions, ...additionalSelections) {
        // Process argument union(s) from method overloads
        const options = isSelectable(selectionOrOptions) || common692d301d_node.isString(selectionOrOptions)
            ? {}
            : selectionOrOptions;
        const selections = isSelectable(selectionOrOptions) || common692d301d_node.isString(selectionOrOptions)
    ...
    offset(offsetOrOptions) {
        ...
        let options;
        let offset;
        if (common692d301d_node.isNumber$1(offsetOrOptions)) {
            options = {};
            offset = offsetOrOptions;
        }
        else {
    ...
    limit(limitOrOptions) {
        // Process argument union(s) from method overloads
        const options = common692d301d_node.isNumber$1(limitOrOptions) ? {} : limitOrOptions;
        const limit = common692d301d_node.isNumber$1(limitOrOptions)
            ? limitOrOptions
    ...
    distinct(groupOrOptions, ...additionalGroups) {
        // Process argument union(s) from method overloads
        const options = common692d301d_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
            ? {}
            : groupOrOptions;
        const groups = common692d301d_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
    ...
    replaceWith(valueOrOptions) {
        // Process argument union(s) from method overloads
        const options = common692d301d_node.isString(valueOrOptions) || isExpr(valueOrOptions) ? {} : valueOrOptions;
        const fieldNameOrExpr = common692d301d_node.isString(valueOrOptions) || isExpr(valueOrOptions)
            ? valueOrOptions
            : valueOrOptions.map;
        // Convert user land convenience types to internal types
    ...
    sample(documentsOrOptions) {
        // Process argument union(s) from method overloads
        const options = common692d301d_node.isNumber$1(documentsOrOptions) ? {} : documentsOrOptions;
        let rate;
        let mode;
        if (common692d301d_node.isNumber$1(documentsOrOptions)) {
            rate = documentsOrOptions;
            mode = 'documents';
        }
        else if (common692d301d_node.isNumber$1(documentsOrOptions.documents)) {
    ...
    unnest(selectableOrOptions, indexField) {
        ...
        if (common692d301d_node.isString(indexFieldName)) {
...
function execute(pipelineOrOptions) {
    ...
    const firestore = common692d301d_node.cast(pipeline._db, common692d301d_node.Firestore);
    const client = common692d301d_node.ensureFirestoreConfigured(firestore);
    const udr = new common692d301d_node.UserDataReader(firestore._databaseId, 
    /* ignoreUndefinedProperties */ true);
    const context = udr.createContext(3 /* UserDataSource.Argument */, 'execute');
    const structuredPipelineOptions = new common692d301d_node.StructuredPipelineOptions(rest, rawOptions);
    structuredPipelineOptions._readUserData(context);
    const structuredPipeline = new common692d301d_node.StructuredPipeline(pipeline, structuredPipelineOptions);
    return common692d301d_node.firestoreClientExecutePipeline(client, structuredPipeline).then(result => {
        ...
        const docs = result
            ...
            ? new common692d301d_node.DocumentReference(firestore, null, element.key)
...
common692d301d_node.Firestore.prototype.pipeline = function () {
    const userDataReader = common692d301d_node.newUserDataReader(this);
    return new PipelineSource(this._databaseId, userDataReader, (stages) => {
        return new Pipeline(this, userDataReader, new common692d301d_node.ExpUserDataWriter(this), stages);
    });
};

exports._internalPipelineToExecutePipelineRequestProto = common692d301d_node._internalPipelineToExecutePipelineRequestProto;
